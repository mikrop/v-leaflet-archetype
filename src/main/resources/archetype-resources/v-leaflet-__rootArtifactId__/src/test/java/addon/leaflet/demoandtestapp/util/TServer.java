...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.addon.leaflet.demoandtestapp.util;
...
public class TServer {
    ...
    public static Server startServer(int port) throws Exception {
        ...
        servletHolder.setInitParameter("widgetset",
                "${package}.addon.leaflet.demoandtestapp.TestWidgetset");

        File file = new File("x:/tmp/${parentArtifactId}/${artifactId}/target/testwebapp");
